...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    name: 'Basreng Bumbu Chili Oil Daun Jeruk',
    category: 'basreng',
    categoryLabel: 'Basreng Chili Oil',
    price: 15000,
    description: 'Bakso goreng stik renyah khas Jawa Barat, dibaluri racikan minyak cabai (chili oil) aromatik dengan wangi daun jeruk segar dan bawang renyah yang menggoda selera.',
  ...
  },
  {
    ...
    name: 'Cireng Isi Ayam Suwir Pedas & Keju',
    category: 'cireng',
    categoryLabel: 'Cireng Isi',
    price: 15000,
    description: 'Cireng khas Bandung dengan tekstur luar krispi renyah dan bagian dalam lembut kenyal, dipadukan dengan isian ayam suwir bumbu merah pedas gurih serta pilihan keju leleh.',
